	...
	public ModelResourceLocation getModelLocation(ItemStack itemStackIn) {
		...
		if (nbtCompound != null)
		{
			...
			if (nbtCompound.getString("material").equals("iron"))
				return new ModelResourceLocation(WateringCans.MODID + ":watering_can", "material=iron");

			// Gold
			if (nbtCompound.getString("material").equals("gold"))
				return new ModelResourceLocation(WateringCans.MODID + ":watering_can", "material=gold");
		}
